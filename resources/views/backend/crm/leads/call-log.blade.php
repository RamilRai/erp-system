...
<div class="modal-body">
    ...
    <form  class="form-validate is-alter" enctype="multipart/form-data" id="callLogForm">
        @csrf
        <div class="row">
            <input type="hidden" class="form-control hidden" id="leadId" name="lead_id" value="{{$post['id']}}">
...
<script>
    ...
    $(document).ready(function(){
        ...
        callLogTable = $('#callLogTable').dataTable({
            ...
            "bProcessing" : true,
            "bServerSide" : true,
            "sAjaxSource" : '{{route('callLog.fetch')}}',
            "oLanguage" : {
            ...
            "fnServerParams": function (aoData) {
                aoData.push({ "name": "lead_id", "value":leadId});
            },
            "aoColumns" : [
                {data:'sn'},
                {data:'calledDate'},
